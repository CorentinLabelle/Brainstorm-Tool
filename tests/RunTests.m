function RunTests()
    ...
    testsToSkip = ["ProtocolManagerTester.m", "PipelineBuilderTester.m", "AutomatedToolTester.m"];

    s = dbstack();
    currentFile = s(1).file;
    
    testFolder = '/mnt/3b5a15cf-20ff-4840-8d84-ddbd428344e9/ALAB1/corentin/scripts/AnalysisTool/tests';
