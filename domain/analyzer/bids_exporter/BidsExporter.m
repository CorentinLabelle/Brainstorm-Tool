classdef BidsExporter < handle
    ...
    methods (Static, Access = private)  
        ...
        function sFile = brainstormExportToBidsFunction(listOfParameters, sFile, bidsPath)
            taskDescription = listOfParameters.getConvertedValue(7);
            datasetDesc = BidsExporter.formatStructToCharacters(listOfParameters.getConvertedValue(8));
            sFile = bst_process('CallProcess', 'process_export_bids', sFile, [], ...
                 ...
                 'edit',          struct(...
                     ...
                     'ProjDesc',    listOfParameters.getConvertedValue(5), ...
                     'Categories',  listOfParameters.getConvertedValue(6), ...
